...
CSRC=ft_printf.c \
	 ...
	 format_char.c format_str.c format_percent.c format_hexadecimal.c format_pointer.c format_octal.c format_unsigned_decimal.c format_decimal.c format_double.c \
	 float.c \
	 pad_printable.c \
	 testing.c
OBJS=ft_printf.o \
	 ...
	 format_char.o format_str.o format_percent.o format_hexadecimal.o format_pointer.o format_octal.o format_unsigned_decimal.o format_decimal.o format_double.o \
	 float.o \
	 pad_printable.o \
	 testing.o
GCH=libftprintf.gch
